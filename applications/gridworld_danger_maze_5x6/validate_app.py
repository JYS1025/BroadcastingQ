...
def main() -> None:
    ...
    print("gridworld_danger_maze_5x6 validation passed")
...
def _validate_structural(path: Path) -> None:
    ...
    try:
        ...
        valid_positions = getattr(env.observation_space, "valid_positions", None)
        for idx in neighbors:
            ...
            if len(candidate) > 2:
                assert np.array_equal(candidate[2:], center[2:])
